...
export default function AutomationRules() {
  ...
  const rulesData = [
    { id: 1, title: 'Smart Lighting',   icon: Lightbulb,   iconBg: 'bg-yellow-50',  iconColor: 'text-yellow-500', ifText: 'Room is empty for 10 minutes',        thenText: 'Turn OFF Lights',        saving: '6%',  defaultEnabled: true  },
    { id: 2, title: 'Smart AC',         icon: Thermometer, iconBg: 'bg-blue-50',    iconColor: 'text-[#2189FF]',  ifText: 'Temperature exceeds 28°C',             thenText: 'Turn ON AC',             saving: '10%', defaultEnabled: true  },
    { id: 3, title: 'Water Heater',     icon: Flame,       iconBg: 'bg-orange-50',  iconColor: 'text-orange-500', ifText: 'Peak Hours (2 PM – 4 PM)',             thenText: 'Delay Heating',          saving: '8%',  defaultEnabled: true  },
    { id: 4, title: 'Smart TV',         icon: Tv,          iconBg: 'bg-indigo-50',  iconColor: 'text-indigo-500', ifText: 'No activity detected for 30 minutes',  thenText: 'Enter Sleep Mode',       saving: '5%',  defaultEnabled: true  },
    { id: 5, title: 'Washing Machine',  icon: Shirt,       iconBg: 'bg-cyan-50',    iconColor: 'text-cyan-500',   ifText: 'Peak Hours',                           thenText: 'Schedule after 6 PM',   saving: '7%',  defaultEnabled: false },
  ]
      ...
      <div className="flex-1 overflow-y-auto px-6 lg:px-10 pb-12 scroll-smooth">
        <div className="max-w-[1500px] mx-auto pt-2 space-y-6 lg:space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 items-stretch">
            <SummaryCard title="Active Rules"            value="12"      icon={CheckCircle2} iconColor="text-green-500"    iconBg="bg-green-50" />
            <SummaryCard title="Estimated Monthly Saving" value="₹840"  icon={Zap}          iconColor="text-[#1428A0]"    iconBg="bg-blue-50" />
            <SummaryCard title="Automated Devices"       value="24"      icon={Cpu}          iconColor="text-[#2189FF]"    iconBg="bg-blue-50/50" />
            <SummaryCard title="Automation Status"       value="Optimal" icon={ShieldCheck}  iconColor="text-purple-500"  iconBg="bg-purple-50" />
          </div>
          ...
          <div className="pt-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 lg:gap-8 items-stretch">
              {rulesData.map((rule) => <AutomationRuleCard key={rule.id} rule={rule} />)}

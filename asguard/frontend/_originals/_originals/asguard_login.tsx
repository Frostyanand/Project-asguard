...
// Custom CSS for animations and Google font import
const styles = `
  ...
  @keyframes scan-beam {
    0% { opacity: 0.1; transform: scaleY(0.95); }
    50% { opacity: 0.4; transform: scaleY(1.05); }
    100% { opacity: 0.1; transform: scaleY(0.95); }
  }
  ...
  .animate-float-slow { animation: float 8s ease-in-out 2s infinite; }
  .animate-scan { animation: scan-beam 3s ease-in-out infinite; transform-origin: top center; }
  .animate-glow { animation: pulse-glow 2.5s infinite; }
  
  .fade-in-up { animation: fade-in-up 0.8s cubic-bezier(0.16, 1, 0.3, 1) forwards; opacity: 0; }
...
const DigitalTwinIllustration = () => {
  return (
    <div className="relative w-full max-w-lg aspect-square flex items-center justify-center">
      ...
      <div className="absolute inset-0 bg-blue-50/50 rounded-full blur-3xl opacity-60"></div>
      ...
      <div className="absolute top-4 right-1/4 z-20 animate-float">
        <div className="relative bg-white border-4 border-gray-900 rounded-[14px] w-12 h-24 shadow-xl flex items-center justify-center">
          <div className="absolute top-1 w-4 h-1 bg-gray-200 rounded-full"></div>
      ...
      {/* Central Wireframe House (Digital Twin) */}
      <div className="relative z-10 w-64 h-64 mt-16 animate-float-delayed">
        <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full drop-shadow-2xl">
          ...
          {/* AI Energy Optimization Grid Lines */}
      ...
      {/* Connected SmartThings Floating Cards */}
        ...
        <div className="hidden lg:flex lg:w-[55%] flex-col relative px-20 py-16 justify-between">
          ...
          <div className="z-10 fade-in-up">
            <h2 className="text-[#1428A0] font-semibold tracking-widest uppercase text-xs mb-4 flex items-center gap-3">
              <span className="w-8 h-[2px] bg-[#2189FF]"></span>
          ...
          <div className="flex gap-8 z-10 fade-in-up delay-200">
            <div className="flex items-center gap-2.5">
              <div className="w-2.5 h-2.5 rounded-full bg-[#2189FF] animate-glow"></div>
            ...
            <div className="bg-white rounded-[24px] p-8 sm:p-12 shadow-[0_8px_40px_rgb(0,0,0,0.04),0_1px_3px_rgb(0,0,0,0.02)] ring-1 ring-gray-100">
              ...
              <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                ...
                <div className="space-y-3.5 pt-2">
                  <button className="w-full bg-[#1428A0] hover:bg-[#102080] text-white font-semibold text-base py-3.5 rounded-xl transition-all shadow-[0_4px_14px_rgba(20,40,160,0.25)] hover:shadow-[0_6px_20px_rgba(20,40,160,0.3)] active:scale-[0.98]">
                    Login
                  </button>
                  
                  <button type="button" className="w-full bg-white ring-1 ring-inset ring-gray-200 hover:bg-gray-50 hover:ring-gray-300 text-gray-700 font-semibold text-base py-3.5 rounded-xl transition-all flex items-center justify-center gap-3 active:scale-[0.98]">
